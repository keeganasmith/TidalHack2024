...
df = pd.read_csv("NHTSACar.csv", encoding="unicode_escape")
...
feature_columns = ["Size_Class","Curb_Wgt","ABS","Airbag_D","SSF","Drive","Drive4","TireSize",
                  ...
                  "HeadAirbag","HeadAirbagRollover","RearSeatHeadRestraint","DynamicHeadRestraint","BuiltInChildSeat",
                  "Roll_Stability","SafetyPowerWindows","WheelsDriven"]
...
df_features['HeadAirbagRollover'] = df_features['HeadAirbagRollover'].equals('Yes')
...
df_features.dropna().reset_index().to_csv('cleaned_features.csv')